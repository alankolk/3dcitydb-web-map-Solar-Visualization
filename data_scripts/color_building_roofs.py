...
# and colours each building rooftop based on the solar potential of the individual polygons of the roof
# @Parameters
# filepath - the visualization export folder generated by the Importer/Exporter tool when exporting as KML Geometry
# tiles - Metadata JSON file that contains buildings with their etak_id-s and the tiles that they are on
# roof_attr_path - city-attributes.json file that the previous pipeline generates
...
#                          "cities/tartu_data/Tiles/",
#                          read_tile_json("cities/tartu_data/Tartu.json"),
